...
D0 = read.csv("E:\\IIIT-Hyderabad\\Proj-Streetlights\\streetlights\\GH061368_streetlights.csv")
D1 = D0[,3:2]
print(D1)
plot(D1)
...
leaflet() %>% 
  ...
  addLegend(pal = palRaster, values = r1@data@values, title = "Streetlight Density")
